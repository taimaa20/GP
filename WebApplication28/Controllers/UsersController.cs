...
namespace WebApplication28.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,FirstName,LastName,Gender,UserImage,Email,PhoneNumber,Adress,City,BirthDate,LoginId")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,FirstName,LastName,Gender,UserImage,Email,PhoneNumber,Adress,City,BirthDate,LoginId")] User user)
        {
            if (id != user.UserId)
            {
                return NotFound();
